...
/**
 * The {@link SQLDialect#XUGU} specific DSL.
 *
 * @author Lukas Eder
 */
public class XuGuDSL extends DSL {
    ...
    // -------------------------------------------------------------------------
    // XuGu-specific compression and encryption functions
    // -------------------------------------------------------------------------

    /**
     * Get the XuGu-specific <code>DECODE()</code> function.
     * <p>
    ...
    /**
     * Get the XuGu-specific <code>ENCODE()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>AES_DECRYPT()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>AES_ENCRYPT()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>DES_DECRYPT()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>DES_ENCRYPT()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>COMPRESS()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>UNCOMPRESS()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>UNCOMPRESSED_LENGTH()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>SHA1()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>SHA2()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>PASSWORD()</code> function.
     */
    @NotNull
    @Support({ XUGU })
    ...
    /**
     * Get the XuGu-specific <code>VALUES()</code> function for use with
    ...
    /**
     * Get a field based {@link EnumType} by its XuGu-specific index.
     * <p>
     * If your XuGu enum type contains these three values: <code>A, B, C</code>
