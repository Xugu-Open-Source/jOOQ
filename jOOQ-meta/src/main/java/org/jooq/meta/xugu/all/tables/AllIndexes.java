...
public class AllIndexes extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Boolean> IS_UNIQUE = createField(DSL.name("IS_UNIQUE"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.inline(false, SQLDataType.BOOLEAN)), this, "");

    /**
     * 添加虚谷字段
     * 判断是否为主键
     */
    public final TableField<Record, Boolean> IS_PRIMARY = createField(DSL.name("IS_PRIMARY"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.inline(false, SQLDataType.BOOLEAN)), this, "");
