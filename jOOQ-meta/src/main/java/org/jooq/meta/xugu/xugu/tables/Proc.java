...
import org.jooq.meta.xugu.xugu.enums.*;
...
public class Proc extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> DB = createField(DSL.name("db"), org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.proc.name</code>.
     */
    public final TableField<Record, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.proc.type</code>.
     */
    public final TableField<Record, ProcType> TYPE = createField(DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(ProcType.class), this, "");

    /**
     * The column <code>mysql.proc.specific_name</code>.
     */
    public final TableField<Record, String> SPECIFIC_NAME = createField(DSL.name("specific_name"), org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.proc.language</code>.
     */
    public final TableField<Record, ProcLanguage> LANGUAGE = createField(DSL.name("language"), org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(DSL.inline("SQL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ProcLanguage.class), this, "");

    /**
     * The column <code>mysql.proc.sql_data_access</code>.
     */
    public final TableField<Record, ProcSqlDataAccess> SQL_DATA_ACCESS = createField(DSL.name("sql_data_access"), org.jooq.impl.SQLDataType.VARCHAR(17).nullable(false).defaultValue(DSL.inline("CONTAINS_SQL", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ProcSqlDataAccess.class), this, "");

    /**
     * The column <code>mysql.proc.is_deterministic</code>.
     */
    public final TableField<Record, ProcIsDeterministic> IS_DETERMINISTIC = createField(DSL.name("is_deterministic"), org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(DSL.inline("NO", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ProcIsDeterministic.class), this, "");

    /**
     * The column <code>mysql.proc.security_type</code>.
     */
    public final TableField<Record, ProcSecurityType> SECURITY_TYPE = createField(DSL.name("security_type"), org.jooq.impl.SQLDataType.VARCHAR(7).nullable(false).defaultValue(DSL.inline("DEFINER", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(ProcSecurityType.class), this, "");
     ...
     */
    public final TableField<Record, String> DEFINER = createField(DSL.name("definer"), org.jooq.impl.SQLDataType.CHAR(93).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.proc.created</code>.
     */
    public final TableField<Record, Timestamp> CREATED = createField(DSL.name("created"), org.jooq.impl.SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mysql.proc.modified</code>.
     */
    public final TableField<Record, Timestamp> MODIFIED = createField(DSL.name("modified"), org.jooq.impl.SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>mysql.proc.sql_mode</code>.
     */
    public final TableField<Record, String> SQL_MODE = createField(DSL.name("sql_mode"), org.jooq.impl.SQLDataType.VARCHAR(478).nullable(false).defaultValue(DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
